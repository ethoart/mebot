...
pm2 save
                      ...
                      <div>
                         <h3 className="text-lg font-bold text-slate-900 mb-2">3. Expose to Domain using Cloudflare Zero Trust</h3>
                         <p className="text-slate-600 mb-2">You don't need to open any AWS security group ingress ports if you use a Cloudflare Tunnel.</p>
                         <ul className="list-disc pl-5 text-slate-600 space-y-1">
                             <li>Login to Cloudflare Zero Trust Dashboard {"->"} Networks {"->"} Tunnels</li>
                             <li>Create a new tunnel and install the <code>cloudflared</code> daemon on your AWS t3 Ubuntu server</li>
                             <li>Route your public host (e.g. <code>mebot.yourdomain.com</code>) to the local service <code>http://localhost:3000</code></li>
                         </ul>
                      </div>
